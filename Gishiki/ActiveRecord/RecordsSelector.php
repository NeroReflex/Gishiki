...
class RecordsSelector
{
     ...
     * 
     * @var int the maximum value of record results
     */
    protected $limit = 0;
     ...
     * 
     * @var int the offset of record results
     */
    protected $offset = 0;
     ...
     * 
     * @var int list of records selectors 
     */
     ...
     * 
     * @param int $limit the maximum value of affected records
     */
     ...
     * number of records
     * 
     * @param int $offset the starting offset of rows to be affected
     */
    ...
    public function __call($name, $arguments)
    {
        if (strpos($name, "where_") === 0) {
            $fieldname = \Gishiki\Algorithms\String_Management::str_replace_once("where_", "", $name);
            $fieldcondition = "";
        ...
        } elseif (strtolower($name) == "offset") {
            $this->set_offset($arguments[0]);
        } elseif (strtolower($name) == "limit") {
