                ...
                if (preg_match_all('/\\{[[:alnum:]]+\\}/', $URI, $params)) {
                    ...
                    if (preg_match("@^".$RegexURI."*$@i", $real_URI)) {
                        ...
                        foreach ($params as &$param) {
                            ...
                            $to_be_splitted = \Gishiki\Algorithms\String::str_replace_once($before_after[0], "", $to_be_splitted);
                            $to_be_splitted = \Gishiki\Algorithms\String::str_replace_once($param, "", $to_be_splitted);
                            ...
                            $real_URI = \Gishiki\Algorithms\String::str_replace_once($before_after[0], "", $real_URI);
                            ...
                            $real_URI = \Gishiki\Algorithms\String::str_replace_once($param_real_value, "", $real_URI);
