...
abstract class DirectSerialization {
    /**
     * Prepare a value to be stored in a cookie
     * 
    ...
    static function SerializeValue($value) {
        ...
        switch ($valuetype) {
            ...
            case "array":
                ...
                break;
            default:
                throw new CookieException("Unserializabe cookie value", 0);
        }
    ...
    /**
     * Unserialize a value serialized by Cookie::Serialize()
     * 
     * @param string $serializedValue the value serialized by Cookie::Serialize()
     */
    static function DeserializeValue($serializedValue) {
        ...
        switch ($valueSplit[0]) {
            ...
            case "array":
                ...
                break;
            default:
                throw new CookieException("Invalid serialized cookie value", 0);
        }
