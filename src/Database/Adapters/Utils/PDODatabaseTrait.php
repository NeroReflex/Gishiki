...
use Gishiki\Database\Adapters\Utils\SQLGenerator\SQLWrapperInterface;
...
trait PDODatabaseTrait
{
    ...
    public function update($collection, $data, SelectionCriteria $where) : int
    {
        ...
        try {
            ...
            return $this->executeQuery($queryBuilder)->rowCount();
        } catch (\Exception $ex) {
    ...
    public function read($collection, SelectionCriteria $where, ResultModifier $mod) : array
    {
        ...
        try {
            ...
            return $this->executeQuery($queryBuilder)->fetchAll(\PDO::FETCH_ASSOC);
        } catch (\Exception $ex) {
    ...
    /**
     * Create the query from the given query builder,
     * execute it and return the execution statement.
     *
     * @param  SQLWrapperInterface $queryBuilder the loaded query builder
     * @return \PDOStatement the statement after query execution
     */
    protected function executeQuery(SQLWrapperInterface &$queryBuilder) : \PDOStatement
    {
