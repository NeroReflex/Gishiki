...
class UriTest extends TestCase
{
    ...
    {
        $uri = $this->uriFactory()->withHost('gishiki.herokuapp.com');

        $this->assertAttributeEquals('gishiki.herokuapp.com', 'host', $uri);
    }
    ...
    public function testWithPathWhenBaseRootIsEmpty()
    {
        ...
        $uri = \Gishiki\HttpKernel\Uri::createFromEnvironment($environment);
